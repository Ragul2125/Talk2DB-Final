...
PURCHSERETURNREQUEST (PURCHASERETURNREQUESTNO TEXT PRIMARY KEY, RETURNREQUESTDATE TIMESTAMP_NTZ, SUPPLIERID NUMBER, STOREID NUMBER, RETURNREQUESTSTATUSID NUMBER, REMARKS TEXT, USERID NUMBER, ISACTIVE BOOLEAN, FOREIGN KEY (SUPPLIERID) REFERENCES SUPPLIER(SUPPLIERID), FOREIGN KEY (STOREID) REFERENCES STORE(STOREID), FOREIGN KEY (RETURNREQUESTSTATUSID) REFERENCES RETURNSTATUS(RETURNREQUESTSTATUSID))
RECEIPTENTRY (RECEIPTENTRYID NUMBER PRIMARY KEY, PAYMENTDATE DATE, PAYMODEID NUMBER, PAIDTO TEXT, CHEQUENO NUMBER, CHEQUEDATE DATE, BANKID TEXT, AREAID TEXT, PAIDAMOUNT NUMBER, ISCHEQUEPRINT BOOLEAN, BANKACCOUNTID NUMBER, ISCHEQUEISSUE BOOLEAN, ISCHEQUEPAID BOOLEAN, PRINTEDON TIMESTAMP_NTZ, ISSUEDON TIMESTAMP_NTZ, PAIDON TIMESTAMP_NTZ, PRINTCOUNT NUMBER, FOREIGN KEY (PAYMODEID) REFERENCES PAYMODE(PAYMODEID), FOREIGN KEY (BANKACCOUNTID) REFERENCES BANKACCOUNT(BANKACCOUNTID))
...
REDEEMDETAIL (REDEEMID NUMBER PRIMARY KEY, REDEEMDATE TIMESTAMP_NTZ, BILLNO NUMBER, CUSTOMERCODE NUMBER, REDEEMPOINT NUMBER, REDEEMAMOUNT NUMBER, ISACTIVE BOOLEAN, FOREIGN KEY (BILLNO) REFERENCES PRODUCTSALE(BILLNO),FOREIGN KEY (CUSTOMERCODE) REFERENCES CUSTOMER(CUSTOMERCODE))
...
PURCHASEWAREHOUSE (ID NUMBER PRIMARY KEY, DATE DATE, GRNCOUNT NUMBER, GRNPRODUCTCOUNT NUMBER, PURCHASEQTY NUMBER, PURCHASEVALUE NUMBER, FREEQTY NUMBER, FREEVALUE NUMBER, REPLACEMENTPRODUCTCOUNT NUMBER, PURREPLACEQTY NUMBER, REPLACEMENTVALUE NUMBER, PURRRT COUNT NUMBER, PURRRTPRODUCTCOUNT NUMBER, PURRRTQTY NUMBER, PURRRTVALUE NUMBER, GRNCANCELCOUNT NUMBER, CANCELPRODUCTCOUNT NUMBER, GRNCANCELQTY NUMBER, CANCELVALUE NUMBER)
...
SALEWAREHOUSE (ID NUMBER PRIMARY KEY, BILLDATE DATE, CASH NUMBER, CARD NUMBER, CREDIT NUMBER, ONLINECASH NUMBER, ONLINECARD NUMBER, ONLINEPAYMENT NUMBER, PREPAID NUMBER, BILLCOUNT NUMBER, SALEVALUE NUMBER, SALEQTY NUMBER, GROCERYSALES NUMBER, AVGBILLVALUE NUMBER, RETURNBILLCOUNT NUMBER, TOTALRETURNVALUE NUMBER, RETURNQTY NUMBER, AVGRETURNVALE NUMBER, TOTALSALES NUMBER, PROFIT NUMBER)
